...
void menu(); //Xinrui Li
void printdata(CustInfo *); //Xinrui Li
void NewCust(CustInfo *); //Xinrui Li
void DelCust(CustInfo *); //Xinrui Li
void editCust(CustInfo *); //Xinrui Li
